...
urlpatterns = [
    ...
    path('events/<str:ticketmaster_id>/', views.ticketmaster_event, name='ticketmaster_event'),
    ...
    path('user/<int:user_id>/delete_going/<int:event_id>', views.delete_going, name='delete_going'),
]